...
/******/ 	var hotCurrentHash = "0c71b60d0e9dc10dc301"; // eslint-disable-line no-unused-vars
...
var _gestureMgmt = __webpack_require__(3);

var _gestureMgmt2 = _interopRequireDefault(_gestureMgmt);
...
var handleWrap = function handleWrap(el, handler) {
	var gestureAdmin = new _gestureMgmt2.default(el);
 ...
 * @class GestureMgmt
 */
var GestureMgmt = function () {
	function GestureMgmt(el) {
		_classCallCheck(this, GestureMgmt);

		this.el = el;
		this.gHandlers = [];
	}

	_createClass(GestureMgmt, [{
		key: 'add',
